...
namespace SchoolApp.WebMvcDbFirst.Data;
...
public partial class MvcDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Courses__3214EC0702015944");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Students__3214EC07BC2AC2A7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Teachers__3214EC0745F948DD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC07005EAE97");
